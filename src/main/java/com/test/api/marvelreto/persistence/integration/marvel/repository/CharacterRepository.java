package com.test.api.marvelreto.persistence.integration.marvel.repository;

import com.fasterxml.jackson.databind.JsonNode;
import com.test.api.marvelreto.dto.MyPageable;
import com.test.api.marvelreto.persistence.integration.marvel.mapper.CharacterMapper;
import com.test.api.marvelreto.persistence.integration.marvel.MarvelAPIConfig;
import com.test.api.marvelreto.persistence.integration.marvel.dto.CharacterDto;
import com.test.api.marvelreto.service.HttpClientService;
...
public class CharacterRepository {
    ...
    private Map<String, String> getQueryParamsForFindAll(MyPageable pageable, String name, int[] comics, int[] series) {
        ...
        if(comics != null){
            String comicsAsString = this.joinIntArrays(comics);
            marvelQueryParams.put("comics", comicsAsString);
        }

        if(series != null){
            String seriesAsString = this.joinIntArrays(series);
     ...
     */
    private String joinIntArrays(int[] comics) {
