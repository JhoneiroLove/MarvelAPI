package com.test.api.marvelreto.web.interceptor;

import com.test.api.marvelreto.exception.ApiErrorException;
import com.test.api.marvelreto.persistence.entity.UserInteractionLog;
import com.test.api.marvelreto.persistence.repository.UserInteractionLogRepository;
import com.test.api.marvelreto.service.AuthenticationService;
...
public class UserInteractionInterceptor implements HandlerInterceptor {
    ...
    @Autowired
    @Lazy // Para evitar la dependencia circular postergando la creación de esta dependencia hasta que sea necesaria
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if(requestURI.startsWith("/comics") || requestURI.startsWith("/characters")){
            ...
            try{
                ...
                throw new ApiErrorException("No se logro guardar el registro de interacción correctamente");
            }
        }
        return true;
    }
