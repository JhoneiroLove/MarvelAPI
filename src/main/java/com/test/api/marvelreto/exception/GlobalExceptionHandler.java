...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorDto> handlerGeneralException(Exception exception,
        ...
        if(exception instanceof HttpClientErrorException){
            ...
            return this.handlerAccesDeniedException((AccessDeniedException) exception, request, webRequest);
    ...
    private ResponseEntity<ApiErrorDto> handlerGenericException(
        ...
        ApiErrorDto dto = new ApiErrorDto(
                "Error inesperado vuelva a intentarlo más tarde",
     ...
     */
    private ResponseEntity<ApiErrorDto> handlerAccesDeniedException(
